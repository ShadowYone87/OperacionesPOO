...
public class Suma extends Operacion {
    ...
    public Suma(double a, double b) {
        super(a, b); // Llamada al constructor de la clase base (Operaciones) con los valores
                     // proporcionados
    }

    // Método que realiza la suma
    public double hacerOperacion() {
        // Retorna la suma de los dos números a y b, los cuales se obtienen mediante los
        // métodos
